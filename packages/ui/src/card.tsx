...
export function Card({
  ...
  return (
    <a
      className="ui-group ui-bg-red-500 ui-rounded-lg ui-border ui-border-transparent ui-px-5 ui-py-4 ui-transition-colors hover:ui-border-neutral-700 hover:ui-bg-neutral-800/30"
